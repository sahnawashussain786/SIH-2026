...
import {
  IconLandmark, IconLock, IconMail, IconError, IconShieldSolid, IconArrowRight, IconBalance,
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden bg-slate-900 p-10 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold leading-tight">Intelligent Land Record System</p>
            <p className="text-xs text-slate-400">Digitization &amp; Validation Platform</p>
          </div>
        </div>

        <div className="relative max-w-md">
          <h2 className="text-3xl font-bold leading-tight">
            From scanned paper to <span className="text-brand-400">verified digital records</span>.
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-slate-400">
            AI-powered extraction across every Indian language, confidence-based routing, and a full
            audit trail — built for revenue departments.
          </p>
          <ul className="mt-8 space-y-4 text-sm">
            {[
              { Icon: IconBalance, title: 'Confidence-based routing', desc: 'Auto-accept, review, or mandatory verification' },
              { Icon: IconShieldSolid, title: 'Role-based access & audit trail', desc: 'Every action is recorded and attributable' },
              { Icon: IconLandmark, title: 'Multilingual extraction', desc: 'Reads khatians in all scheduled Indian languages' },
            ].map(({ Icon, title, desc }) => (
        ...
        <p className="relative text-xs text-slate-500">Smart India Hackathon 2026 · Government of India</p>
      </div>
      ...
      <div className="flex items-center justify-center bg-slate-100 p-4 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 flex items-center gap-3 lg:hidden">
            ...
            <div>
              <p className="font-bold leading-tight text-slate-900">Intelligent Land Record System</p>
              <p className="text-xs text-slate-500">Digitization &amp; Validation Platform · SIH 2026</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-white p-8 shadow-card ring-1 ring-slate-200/70">
            ...
            <p className="mt-1 text-sm text-slate-500">Use your official department credentials.</p>
